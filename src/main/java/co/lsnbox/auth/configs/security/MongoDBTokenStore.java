...
import co.lsnbox.auth.models.oauth.OAuth2AuthenticationAccessToken;
import co.lsnbox.auth.models.oauth.OAuth2AuthenticationRefreshToken;
...
public class MongoDBTokenStore implements TokenStore {
    ...
    public OAuth2AccessToken getAccessToken(OAuth2Authentication authentication) {
        ...
        OAuth2AuthenticationAccessToken token =  oAuth2AccessTokenRepository.findByAuthenticationId(key);
        System.out.println();
